    ...
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <button 
          ...
          className="py-2 px-6 mt-6 bg-zinck-800 rounded-md border-transparent text-sm leading-6 hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-rose-900 transition-colors disabled:opacity-50 disabled:hover:bg-rose-900"
        >
          Quero enviar outro...
        </button>
      </div>
